export const homeObjOne = {
    ...
    imgStart: '',
    img: './u-pick-react-site/upick_logo_square.png',
    alt: 'Credit card',
...
export const homeObjThree = {
    ...
    buttonLabel: 'Download Now',
    imgStart: '',
    img: './u-pick-react-site/contact_image.svg',
    alt: 'Credit card',
    hasDownloadButton: false,
    hasContactForm: true,
    hasButton: false
...
export const homeObjFour = {
    ...
    lightText: true,
    lightTextDesc: true,
    topLine: 'Available now on Google Play and the App Store',
    headline: 'Download Now!',
    description: 'UPick is now available on both Android and Iphone devices. Download for free to start your search!',
    buttonLabel: 'Download please',
    imgStart: 'start',
    img: './u-pick-react-site/download_image.svg',
    alt: 'Credit card',
