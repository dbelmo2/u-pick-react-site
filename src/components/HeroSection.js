                    ...
                    <div className="home__hero-text-wrapper">
                        ...
                        <div className="home__download-container">
                            <a href={APPSTORE_PATH}>
                                <img alt="AppStore" src="./u-pick-react-site/appstore_badge.svg" className="home__download-img"/>
                            </a>
                        
                            <a href={GOOGLEPLAY_PATH}>
                                <img alt="Google Play" src="./u-pick-react-site/google_play_badge.png" className="home__download-img"/>
                            </a>
                        </div>
                        </>
